...
const WORKOUTS = {
  ...
  B: {
    ...
    exercises: [
      ...
      { name: "Rear Delt Fly", sets: 3, reps: "12", type: "isolation", videoId: "lPt0GqwaqEw",
      ...
      { name: "Dumbbell Curl", sets: 3, reps: "10", type: "isolation", videoId: "XE_pHwbst04",
        ...
        muscles: "Biceps" },
      { name: "Hammer Curl", sets: 3, reps: "10", type: "isolation", videoId: "zC3nLlEVfgo",
  ...
  C: {
    ...
    exercises: [
      ...
      { name: "Dumbbell RDL (Romanian Deadlift)", sets: 3, reps: "10", type: "compound", videoId: "hQgFixeXdZo",
      ...
      { name: "Bulgarian Split Squat", sets: 3, reps: "8 each", type: "compound", videoId: "QbR-OkX3HFE",
      ...
      { name: "Dumbbell Leg Curl", sets: 3, reps: "12", type: "isolation", videoId: "Orxowest56U",
        ...
        muscles: "Hamstrings" },
      { name: "Dumbbell Hip Thrust", sets: 3, reps: "12", type: "isolation", videoId: "29OfN4ztW_g",
