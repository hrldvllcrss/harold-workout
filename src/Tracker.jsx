...
const WORKOUTS = {
  A: {
    ...
    exercises: [
      ...
      { name: "Dead Bug", sets: 3, reps: "10 each", type: "core", videoId: "9RK9UUgKIQE",
  ...
  B: {
    ...
    exercises: [
      ...
      { name: "Stationary Lunges", sets: 3, reps: "8 each", type: "compound", videoId: "xrPteyQLGAo",
      ...
      { name: "Dumbbell Calf Raise", sets: 3, reps: "15", type: "isolation", videoId: "wxwY7GXxL4k",
