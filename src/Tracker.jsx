...
const WORKOUTS = {
  ...
  B: {
    ...
    exercises: [
      ...
      { name: "Dumbbell Shrug", sets: 3, reps: "12", type: "isolation", videoId: "cJRVVxmytaM",
      ...
      { name: "Dead Bug", sets: 3, reps: "8 each", type: "core", videoId: "9RK9UUgKIQE",
  ...
  C: {
    ...
    exercises: [
      { name: "Bodyweight Squat", sets: 3, reps: "10", type: "compound", videoId: "l83R5PblSMA",
        howTo: "Stand with feet shoulder-width apart, toes slightly out. Arms out in front for balance. Squat down by pushing hips back and bending knees until thighs are parallel (or as low as comfortable). Push through heels to stand back up.",
        tips: "No weight needed \u2014 master the movement first. Keep chest up and don't let knees cave inward. Go as low as you comfortably can and build depth over time. Weeks 3+: hold a light dumbbell at your chest to progress to Goblet Squat.",
        muscles: "Quads, Glutes, Core" },
      { name: "Dead Bug", sets: 3, reps: "8 each", type: "core", videoId: "9RK9UUgKIQE",
        howTo: "Lie on your back. Arms pointing straight up toward ceiling. Knees bent at 90\u00b0 (shins parallel to floor). Slowly extend your RIGHT arm behind your head while extending your LEFT leg straight out. Return to start. Repeat with opposite arm/leg.",
        tips: "The KEY is keeping your lower back pressed into the floor the entire time. If your back arches, you've gone too far. Go slow \u2014 this is harder than it looks.",
        muscles: "Deep Core, Stability" },
      { name: "Glute Bridge", sets: 3, reps: "12", type: "compound", videoId: "OUgsJ8-Vi0E",
        howTo: "Lie on your back, knees bent, feet flat on floor hip-width apart. Push through your heels and squeeze your glutes to lift your hips up until your body forms a straight line from shoulders to knees. Hold for 1 second at the top. Lower slowly.",
        tips: "Squeeze your glutes HARD at the top \u2014 that's where the magic happens. Don't push through your lower back. Weeks 3+: put your feet on the bench for extra range. Weeks 5+: place a dumbbell on your hips.",
        muscles: "Glutes, Hamstrings, Core" },
      { name: "Wall Sit", sets: 3, reps: "20s", type: "compound", videoId: "JaZNYM3zAP0",
        howTo: "Stand with your back flat against a wall. Slide down until your thighs are parallel to the floor (or as low as comfortable). Knees at 90\u00b0, directly above ankles. Hold the position.",
        tips: "Keep your back flat against the wall and don't let your knees go past your toes. Start with 15-20 seconds and build up. If it's too hard, don't slide down as far. Build up: 20s \u2192 30s \u2192 45s over the weeks.",
        muscles: "Quads, Glutes, Endurance" },
      { name: "Calf Raise", sets: 3, reps: "15", type: "isolation", videoId: "wxwY7GXxL4k",
        howTo: "Stand with feet hip-width apart. Rise up onto your toes as high as you can. Hold for 1 second at the top. Lower slowly (2-3 seconds down). For a deeper stretch, stand on the edge of a step with heels hanging off.",
        tips: "Start bodyweight only \u2014 add dumbbells when it feels easy. Go slow, calves respond to time under tension. Don't bounce. Full range of motion: all the way up, all the way down.",
        muscles: "Calves" },
      { name: "Plank", sets: 3, reps: "15s", type: "core", videoId: "iDSHokfXqyA",
        howTo: "Weeks 1-4: KNEE PLANK \u2014 Forearms on ground, knees on ground, body straight from head to knees. Hold position. Weeks 5+: FULL PLANK \u2014 Same but on toes. Keep core tight, don't let hips sag or pike up.",
        tips: "Start on your knees \u2014 no shame in that. Breathe normally, don't hold your breath. Squeeze your glutes. Build up: 15s \u2192 20s \u2192 30s \u2192 45s over the weeks.",
        muscles: "Core, Shoulders, Lower Back" },
    ],
  },
};
