...
const WORKOUTS = {
  ...
  C: {
    ...
    exercises: [
      ...
      { name: "Romanian Deadlift", sets: 3, reps: "10", type: "compound", videoId: "zU-f6DMCdAI",
      ...
      { name: "Bench Step-Up", sets: 3, reps: "8 each", type: "compound", videoId: "DxUNi119Qzs",
      ...
      { name: "Dumbbell Lunge", sets: 2, reps: "8 each", type: "compound", videoId: "xrPteyQLGAo",
        ...
        muscles: "Quads, Glutes, Balance" },
      { name: "Calf Raise", sets: 3, reps: "15", type: "isolation", videoId: "Zep-wKHWkNM",
        ...
        muscles: "Calves" },
      { name: "Bench Leg Raise", sets: 3, reps: "10", type: "core", videoId: "0tzBVqiDwSs",
